...
// 进行分页数据查询 注意page方法的参数的前面部分是当前的页数使用 $_GET[p]获取
        ...
        $APPSECRET = 'a62dcaecc8311010b3533b04c6613a83'; 
        $url = 'http://easydai.site';
    ...
    public function sendMsg($name, $phone)
    {
        ...
        $request->setPhoneNumbers("13952412600");
        //必填-短信签名
        ...
        $this->success("您的贷款申请已提交成功，客户经理会尽快与您联系，请保持电话畅通！", url("Index/index"));
    }
