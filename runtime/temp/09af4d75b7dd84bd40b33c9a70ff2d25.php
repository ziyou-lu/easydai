<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\wwwroot\host705123955\wwwroot/apps/home\view\customer\form.html";i:1505019642;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<div class="main">
			<div class="container">
				<div class="main_top">
					<img src="__STATIC__/images/title.jpg" style="width: 100%;height: 400px;">
					<div class="container">
					</div>
				</div>
				<div class="main_bottom mar-top">
					<p>请认真填写您的个人资料</p>
					<p style="margin-top: 20px;color: red;">（注：该表单中除了标有（可不填）的其他都是必填项，写有单位的输入框请根据相应单位填入数字即可）</p>
					<div class="row post">
						<div class="col-lg-8 col-lg-offset-2">
							<form action="<?php echo url('Customer/add'); ?>" method="post" id="personal_form">
								...
								<div style="color: red;margin-bottom: 20px;">*本人承诺不会透漏任何客户个人信息</div>
								<div class="form-group">
		...
		<footer>
			<div class="footer">本网站所有规则最终解释权由张经理所有&nbsp;Copyright 2017 - 2017 <</div>
		</footer>
