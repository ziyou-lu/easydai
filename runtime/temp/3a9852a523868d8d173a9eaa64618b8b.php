<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"/data/home/xyu3066030001/htdocs/apps/admin/view/manager/index.html";i:1500882036;s:66:"/data/home/xyu3066030001/htdocs/apps/admin/view/public/layout.html";i:1500882038;s:63:"/data/home/xyu3066030001/htdocs/apps/admin/view/public/nav.html";i:1500882039;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <table class="flex-table">
      ...
      <?php if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr class="hover erow">
          ...
          <td class="handle"><a class="btn red" href="<?php echo url('admin/manager/del',['id'=>$vo['userid']]); ?>" onclick="if(confirm('删除后将不能恢复，确认删除这  1 项吗？')){return true;} else {return false;}"><i class="icon iconfont icon-shanchu"></i>删除</a>
...
function fg_operation(name, grid) {
    if (name == 'add') {
        window.location.href = "<?php echo url('admin/manager/add'); ?>";
    }
}
</script>
