<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/data/home/xyu3066030001/htdocs/apps/home/view/index/index.html";i:1507451326;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="main_bottom mar-top">
					...
					<div class="row post">
						<div class="col-lg-8 col-lg-offset-2">
							<form action="<?php echo url('Index/add'); ?>" method="post" id="personal_form">
