<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/data/home/xyu3066030001/htdocs/apps/admin/view/action/actionlog.html";i:1500882033;s:66:"/data/home/xyu3066030001/htdocs/apps/admin/view/public/layout.html";i:1500882038;s:63:"/data/home/xyu3066030001/htdocs/apps/admin/view/public/nav.html";i:1500882039;}*/ ?>
<!doctype html>
<html>
<head>
...
$(function(){
    $("#flexigrid").flexigrid({
      ...
      buttons : [
          {display: '<i class="icon iconfont icon-shanchu"></i>批量删除', name : 'delete', bclass : 'del', title : '将选定行数据批量删除', onpress : fg_operate },
          {display: '<i class="icon iconfont icon-yue"></i>删除1个月前的数据', name : 'delete_ago', bclass : 'del', title : '将选定行数据批量删除', onpress : fg_operate },
          {display: '<i class="icon iconfont icon-daochuExcelbiaoge"></i>导出数据', name : 'csv', bclass : 'csv', title : '将选定行数据导出excel文件,如果不选中行，将导出列表所有数据', onpress : fg_operate }
      ],
      searchitems : [
