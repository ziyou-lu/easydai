<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"C:\wamp64\www\szdk/apps/admin\view\customer\index.html";i:1500740907;s:53:"C:\wamp64\www\szdk/apps/admin\view\Public\layout.html";i:1500180864;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <table class="flex-table">
            ...
            <div>
                ...
                <tr <?php if($index % 2 != 0) echo "bgcolor=\"#B0E2FF\"";?> height="30px" >
                    ...
                    <td width="10%" align="center"><?php echo $custom["phone"];?></td>
                    <td width="10%" align="center"><?php echo $custom["uid"];?></td>
                    <td width="5%" align="center"><?php echo $custom["shebao_years"];?></td>
                    <td width="10%" align="center"><?php echo $custom["shebao_num"];?></td>
                    <td width="10%" align="center"><?php echo $custom["work_years"];?></td>
                    <td width="10%" align="center"><?php echo $custom["work_wages"];?></td>
                    <td width="10%" align="center"><?php echo $custom["update_time"];?></td>
                    <td width="10%" align="center"><?php echo $custom["wechat"];?></td>
                    <td width="10%" align="center"><?php echo $custom["hometown"];?></td>
                    <td width="10%" align="center"><a class="btn red" <?php echo 'href="javascript:if(confirm(\'您确定要删除吗?\')){location.href=\'';?><?php echo url("Customer/delete",array("id" => $custom["id"])).'\''.'}"';?>><i class="icon iconfont icon-shanchu"></i>删除</a></td>
                </tr>
                <?php endforeach;?>
            </div>
