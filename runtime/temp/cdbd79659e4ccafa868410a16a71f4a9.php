<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"/data/home/xyu3066030001/htdocs/apps/admin/view/menu/edit.html";i:1500882038;s:66:"/data/home/xyu3066030001/htdocs/apps/admin/view/public/layout.html";i:1500882038;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo url("menu/index"); ?>" title="返回菜单列表"><i class="icon iconfont icon-fanhui"></i></a>
      <div class="subject">
        <h3>后台菜单管理 - 编辑</h3>
        <h5>所有后台菜单索引及管理</h5>
      </div>
...
<dl class="row">
        ...
        <dl class="row">
          ...
          <dd class="opt">
            <input type="text" class="input-txt" name="title" id="title" value="<?php echo $data['title']; ?>" />
            <span class="err"></span>
          </dd>
        </dl>
        <dl class="row">
          ...
          <dd class="opt">
            <input type="text" class="input-txt" name="app" id="app" value="<?php echo $data['app']; ?>" />
            <span class="err"></span>
          </dd>
        </dl>
        <dl class="row">
          ...
          <dd class="opt">
            <input type="text" class="input-txt" name="controller" id="controller" value="<?php echo $data['controller']; ?>" />
            <span class="err"></span>
          </dd>
        </dl>
        <dl class="row">
          ...
          <dd class="opt">
            <input type="text" class="input-txt" name="action" id="action" value="<?php echo $data['action']; ?>" />
            <span class="err"></span>
          </dd>
        </dl>
        <dl class="row">
          ...
          <dd class="opt">
            <input type="text" class="input-txt" name="parameter" id="parameter" value="<?php echo $data['parameter']; ?>" />
            <span class="err"></span>
          </dd>
        </dl>
        <dl class="row">
          ...
          <dd class="opt">
            <div class="onoff">
              <label for="status1" class="cb-enable <?php if($data['status'] == '1'): ?>selected<?php endif; ?>">是</label>
              <label for="status0" class="cb-disable <?php if($data['status'] == '0'): ?>selected<?php endif; ?>">否</label>
