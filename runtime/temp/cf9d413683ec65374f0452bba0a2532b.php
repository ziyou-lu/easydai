<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/data/home/xyu3066030001/htdocs/apps/admin/view/auth_manager/managergroup.html";i:1500882034;s:66:"/data/home/xyu3066030001/htdocs/apps/admin/view/public/layout.html";i:1500882038;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="<?php echo url('AuthManager/index'); ?>" title="返回列表"><i class="icon iconfont icon-fanhui"></i></a>
      <div class="subject">
  ...
  <form action="<?php echo url('AuthManager/writeGroup'); ?>" name="adminForm" id="add_form" enctype="application/x-www-form-urlencoded" method="POST" class="form-horizontal auth-form" style="margin-bottom: 50px;">
