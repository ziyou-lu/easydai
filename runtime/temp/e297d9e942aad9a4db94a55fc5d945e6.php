<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\wwwroot\host707202214\wwwroot/apps/home\view\guoyanping\index.html";i:1508053938;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="main_bottom mar-top">
					...
					<div class="row post">
						<div class="col-lg-8 col-lg-offset-2">
							<form action="<?php echo url('Guoyanping/add'); ?>" method="post" id="personal_form">
