<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"E:\wwwroot\host707202214\wwwroot/apps/admin\view\login.html";i:1507517646;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="login-layout">
    ...
    <form action="<?php echo url('admin/index/login'); ?>" method="post" id="form_login">
