<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\wwwroot\host707202214\wwwroot/apps/home\view\index\index.html";i:1512297411;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<head>
		...
		<meta name="keywords" content="极速" /> 
        <meta name="description" content="五分钟申请，三小时审核，极速放款" /> 
	</head>
	...
	<body>
		...
		<div class="main">
			<div class="container">
				...
				<div class="main_bottom mar-top form-div">
					<p>请认真填写您的个人资料</p>
		...
		<script>
			...
			wx.onMenuShareTimeline({ 
				...
				title: '极速贷款', // 分享标题 
				desc: '五分钟申请，三小时审核，极速下款', // 分享描述
				link: '<?php echo $url;?>', // 分享链接 
				imgUrl: 'http://easydai.site/static/images/icon.jpg', // 分享图标 
				success: function() { 
					alert("已分享");										
					// 用户确认分享后执行的回调函数 
				}, 
